...
static llvm::cl::opt<uint64_t> TagValue("tag-value", 
    llvm::cl::desc("Specify the tag value to apply (0-15)"),
    llvm::cl::value_desc("tag number"),
    llvm::cl::init(0));  // Default value is 0
...
namespace
{
    struct ModifyLoadStoreAddrsPass : public FunctionPass
    {
        ...
        Value *modifyPointerAddress(IRBuilder<> &Builder, Value *originalPtr)
        {
            ...
            uint64_t expectedByte = static_cast<uint64_t>(TagValue) << 56;
